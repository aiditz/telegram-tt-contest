...
const testCases = [
  ...
  // monospace and code can not contain other tags
  {
  ...
  {
    description: 'multiple incomplete nested tags',
    inputText: '**bold *italic ~~strike** italic* strike~~',
    expectedText: '<b>bold <i>italic ~~strike</i></b> italic* strike~~',
  },
  {
  ...
  {
    description: 'mixed incomplete and complete nested structures',
    inputText: '**bold *italic ~~strike~~ bold** *more italic',
    expectedText: '<b>bold <i>italic <s>strike</s> bold</i></b> *more italic',
  },
  {
    description: 'simple code and pre interactions',
    inputText: '`code ```pre``` code`',
    expectedText: '<code>code ```pre``` code</code>',
  },
  {
    description: 'complex code and pre interactions',
    inputText: '`code ```pre``` code` ```pre `code` pre```',
    expectedText: '<code>code ```pre``` code</code> <code>pre `code` pre</code>',
  },
  {
